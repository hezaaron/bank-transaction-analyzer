...
/**
 * Precompiled bank.transaction.analyzer.java-library-conventions script plugin.
 **/
public class BankTransactionAnalyzerJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BankTransactionAnalyzerJavaLibraryConventions").asSubclass(BasicScript.class);
