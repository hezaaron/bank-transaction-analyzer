...
/**
 * Precompiled bank.transaction.analyzer.java-common-conventions script plugin.
 **/
public class BankTransactionAnalyzerJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BankTransactionAnalyzerJavaCommonConventions").asSubclass(BasicScript.class);
